          ...
          >
            <div className="input-row flex flex-col items-center justify-center gap-x-4 gap-y-4 md:flex-row md:gap-y-0">
              <div className="input-container flex w-full flex-col items-center gap-y-2">
                <div className="form-heading w-full font-orbitron">
                  Full Name
                </div>
              ...
              <div className="input-container flex w-full flex-col items-center gap-y-2">
                <div className="form-heading w-full font-orbitron">Email</div>
                <input
                  required
                  type="email"
                  name="email"
            ...
            <div className="input-row flex flex-col items-center justify-center gap-x-4 gap-y-4 md:flex-row md:gap-y-0">
              ...
              <div className="input-container flex w-full flex-col items-center gap-y-2">
                <div className="form-heading w-full font-orbitron">Budget</div>
